...
const Header = () => {
  ...
  return (
    <header ref={headerRef} className="fixed top-0 left-0 right-0 z-[100] flex flex-col isolation-auto">
      ...
      <motion.div 
        className={cn(
          "w-full bg-[#0b1f3a] text-white/80 transition-all duration-300 overflow-hidden relative z-[101]",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex justify-between items-center text-xs sm:text-sm font-medium">
          <div className="flex items-center space-x-6">
            ...
            >
              <Phone className="h-3.5 w-3.5 mr-2 text-blue-200 group-hover:scale-110 transition-transform" />
          ...
          <div className="flex items-center space-x-6">
            <a
              ...
              className="hidden md:flex items-center hover:text-blue-200 transition-colors group"
            >
              <MapPin className="h-3.5 w-3.5 mr-2 text-blue-200 group-hover:scale-110 transition-transform" />
              <span>
	            ...
	            >
	                    ...
	                    <AnimatePresence>
	                      {link.submenu && hoveredLink === link.label && (
	                        ...
	                        >
	                          ...
	                          <div className="bg-[#102a4a] border border-white/10 rounded-xl shadow-2xl overflow-hidden p-2 relative z-[103]">
	              ...
	              <Link href="/schedule#appointment">
	                <Button 
	                  ...
	                  className="bg-primary text-white hover:bg-primary/90 hover:scale-105 transition-all duration-300 font-semibold rounded-full px-3 xl:px-6 text-xs xl:text-sm shadow-[0_0_15px_rgba(59,130,246,0.35)] hover:shadow-[0_0_25px_rgba(59,130,246,0.5)] whitespace-nowrap"
	                >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
            ...
            >
                      ...
                      <Link href={link.href}>
	                        <div 
	                          ...
	                          className={cn(
	                            ...
	                            isActive(link.href) ? "text-blue-200" : "text-white/80"
	                          )}
	                        >
                      ...
                      <div className="border-b border-white/5">
	                        <button
	                          ...
	                          className={cn(
	                            ...
	                            isActive(link.href) || isParentActive(link.submenu) ? "text-blue-200" : "text-white/80"
	                          )}
	                        >
                          <span className="group-active:scale-95 transition-transform">{link.label}</span>
	                          <ChevronDown 
	                            className={cn(
	                              ...
	                              expandedMenus.includes(link.label) ? "rotate-180 text-blue-200" : "text-white/50"
	                            )} 
	                          />
                        </button>
                          ...
                          {expandedMenus.includes(link.label) && (
                            <motion.div
                              ...
                              transition={{ duration: 0.3, ease: "easeInOut" }}
	                            ...
	                            >
	                              <div className="pl-4 pb-4 space-y-1 border-l-2 border-blue-200/30 ml-1 mb-2">
	                                  ...
	                                  <Link key={subLink.href} href={subLink.href}>
	                                    <div
	                                      ...
	                                      className={cn(
	                                        ...
	                                        isActive(subLink.href) ? "text-blue-200" : "text-white/70"
	                                      )}
	                                    >
	                                      {subLink.label}
                                    </div>
              ...
              >
                <Link href="/schedule#appointment">
                  <Button className="w-full bg-primary text-white hover:bg-primary/90 font-bold text-lg h-14 rounded-xl shadow-lg active:scale-[0.98] transition-all">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  ...
                  >
                    <Phone className="h-6 w-6 mb-2 text-blue-200" />
