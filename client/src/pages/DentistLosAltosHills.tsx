...
const DentistLosAltosHills = () => {
  const seo = getSeoForPath("/dentist-los-altos-hills");
  ...
  const breadcrumbItems = [
    { name: "Home", path: "/" },
    { name: "Los Altos Hills Dentist", path: "/dentist-los-altos-hills" },
  ];

  const faqs = [
    {
      question: "Do you accept patients from Los Altos Hills?",
      answer:
        "Yes. Patients from Los Altos Hills visit our Palo Alto office for preventive care, cosmetic dentistry, and restorative treatment.",
    },
    {
      question: "How far is your office from Los Altos Hills?",
      answer:
        "Our office is a short drive from Los Altos Hills. We will share the easiest route and arrival tips when you schedule.",
    },
    {
  ...
  const faqSchema = buildFAQSchema(faqs, "/dentist-los-altos-hills");
  ...
  const relatedServices: RelatedServiceLink[] = [
    {
      ...
      anchorText: "Dental cleanings near Los Altos Hills",
    ...
    {
      href: "/invisalign",
      anchorText: "Invisalign near Los Altos Hills",
      description: "Clear aligners designed for busy schedules.",
    },
    {
      href: "/emergency-dental",
      anchorText: "Emergency dentist near Los Altos Hills",
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-lg text-slate-700 leading-relaxed max-w-3xl">
                Los Altos Hills patients choose Dr. Christopher B. Wong for modern, conservative dentistry in nearby Palo Alto.
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Dental care for Los Altos Hills patients
            </h2>
            <p className="text-slate-700 leading-relaxed">
              Los Altos Hills patients often want a practice that feels consistent and easy to work with. We focus on early
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Common visits for Los Altos Hills patients
            </h2>
            <p className="text-slate-700 leading-relaxed">
              We see Los Altos Hills patients for routine{" "}
            ...
            <p className="text-slate-700 leading-relaxed">
              Invisalign is also popular for Los Altos Hills patients who want a discreet option for alignment. We will outline
...
export default DentistLosAltosHills;
