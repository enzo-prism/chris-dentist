...
const DentistRedwoodShores = () => {
  const seo = getSeoForPath("/dentist-redwood-shores");
  ...
  const breadcrumbItems = [
    { name: "Home", path: "/" },
    { name: "Redwood Shores Dentist", path: "/dentist-redwood-shores" },
  ];

  const faqs = [
    {
      question: "Do you accept patients from Redwood Shores?",
      answer:
        "Yes. Redwood Shores patients visit our Palo Alto office for preventive care, restorative treatment, Invisalign, and cosmetic dentistry.",
    },
    {
      question: "How far is your office from Redwood Shores?",
      answer:
        "We are a short drive from Redwood Shores. When you schedule, we will share the easiest routes and arrival tips.",
    },
    {
    ...
    {
      question: "Do you offer Invisalign for Redwood Shores patients?",
      answer:
        "Yes. Invisalign is a popular option for Redwood Shores patients who want a discreet orthodontic plan.",
    },
    {
  ...
  const faqSchema = buildFAQSchema(faqs, "/dentist-redwood-shores");
  ...
  const relatedServices: RelatedServiceLink[] = [
    {
      ...
      anchorText: "Pediatric dentist near Redwood Shores",
      description: "Gentle care for kids and teens in a calm environment.",
    },
    {
      href: "/dental-cleaning-palo-alto",
      anchorText: "Dental cleanings near Redwood Shores",
    ...
    {
      href: "/invisalign",
      anchorText: "Invisalign near Redwood Shores",
      description: "Clear aligners for teens and adults.",
    },
    {
      href: "/emergency-dental",
      anchorText: "Emergency dentist near Redwood Shores",
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl font-bold font-heading text-[#1F2933]">
                Redwood Shores Dentist - Care Nearby in Palo Alto
              </h1>
              <p className="text-lg text-slate-700 leading-relaxed max-w-3xl">
                Redwood Shores patients visit Dr. Christopher B. Wong for modern, conservative dental care in nearby Palo Alto.
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Family dentistry for Redwood Shores patients
            </h2>
            <p className="text-slate-700 leading-relaxed">
              Redwood Shores families often want a practice that feels calm, consistent, and easy to work with. We focus on
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Common visits for Redwood Shores families
            </h2>
            <p className="text-slate-700 leading-relaxed">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              is a popular option for Redwood Shores patients because it fits work and school schedules. For cosmetic goals,
...
export default DentistRedwoodShores;
