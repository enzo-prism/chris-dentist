...
const DentistMountainView = () => {
  const seo = getSeoForPath("/dentist-mountain-view");
  ...
  const breadcrumbItems = [
    { name: "Home", path: "/" },
    { name: "Mountain View Family Dentist", path: "/dentist-mountain-view" },
  ];

  const faqs = [
    {
      question: "Do you accept patients from Mountain View?",
      answer:
        "Yes. Many Mountain View patients visit our Palo Alto office for preventive care, restorative treatment, and cosmetic dentistry.",
    },
    {
      question: "How far is your office from Mountain View?",
      answer:
        "We are a short drive from Mountain View. When you schedule, we share the easiest routes and arrival tips.",
    },
    {
    ...
    {
      question: "Do you offer Invisalign for Mountain View patients?",
      answer:
        "Yes. Invisalign is a popular option for Mountain View patients who want a discreet orthodontic plan.",
    },
    {
  ...
  const relatedServices: RelatedServiceLink[] = [
    ...
    {
      href: "/invisalign",
      anchorText: "Invisalign near Mountain View",
      description: "Clear aligners for teens and adults.",
    },
    {
      href: "/emergency-dental",
      anchorText: "Emergency dentist near Mountain View",
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Family dentistry for Mountain View patients
            </h2>
            <p className="text-slate-700 leading-relaxed">
              Mountain View families often want a practice that feels calm, consistent, and easy to work with. We focus on
              prevention, clear communication, and conservative care so you can keep your dental health on track without
              surprises.
            </p>
            <p className="text-slate-700 leading-relaxed">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Common visits for Mountain View families
            </h2>
            <p className="text-slate-700 leading-relaxed">
...
export default DentistMountainView;
