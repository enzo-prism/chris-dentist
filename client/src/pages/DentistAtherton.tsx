...
const DentistAtherton = () => {
  const seo = getSeoForPath("/dentist-atherton");
  ...
  const breadcrumbItems = [
    { name: "Home", path: "/" },
    { name: "Atherton Dentist", path: "/dentist-atherton" },
  ];

  const faqs = [
    {
      question: "Do you accept patients from Atherton?",
      answer:
        "Yes. Atherton patients visit our Palo Alto office for preventive care, restorative treatment, Invisalign, and cosmetic dentistry.",
    },
    {
      question: "How far is your office from Atherton?",
      answer:
        "We are a short drive from Atherton. When you schedule, we will share the easiest routes and arrival tips.",
    },
    {
      question: "Do you see kids, teens, and adults?",
      answer:
        "Yes. We provide family dentistry for every age and focus on prevention, comfort, and clear explanations.",
    },
    {
      question: "Do you offer Invisalign for Atherton patients?",
      answer:
        "Yes. Invisalign is a popular option for Atherton patients who want a discreet orthodontic plan.",
    },
    {
  ...
  const faqSchema = buildFAQSchema(faqs, "/dentist-atherton");
  ...
  const relatedServices: RelatedServiceLink[] = [
    ...
    {
      href: "/invisalign",
      anchorText: "Invisalign near Atherton",
      description: "Clear aligners for teens and adults.",
    },
    {
      href: "/emergency-dental",
      anchorText: "Emergency dentist near Atherton",
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-lg text-slate-700 leading-relaxed max-w-3xl">
                Atherton patients visit Dr. Christopher B. Wong for modern, conservative dental care in nearby Palo Alto.
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Family dentistry for Atherton patients
            </h2>
            <p className="text-slate-700 leading-relaxed">
              Atherton families often want a practice that feels calm, consistent, and easy to work with. We focus on
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Common visits for Atherton families
            </h2>
            <p className="text-slate-700 leading-relaxed">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              is a popular option for Atherton patients because it fits work and school schedules. For cosmetic goals,
...
export default DentistAtherton;
