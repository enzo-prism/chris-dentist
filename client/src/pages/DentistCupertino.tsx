...
const DentistCupertino = () => {
  const seo = getSeoForPath("/dentist-cupertino");
  ...
  const breadcrumbItems = [
    { name: "Home", path: "/" },
    { name: "Cupertino Family Dentist", path: "/dentist-cupertino" },
  ];

  const faqs = [
    {
      question: "Do you accept patients from Cupertino?",
      answer:
        "Yes. Cupertino patients visit our Palo Alto office for preventive care, restorative treatment, Invisalign, and cosmetic dentistry.",
    },
    {
      question: "How far is your office from Cupertino?",
      answer:
        "We are a straightforward drive from Cupertino. When you schedule, we will share the easiest routes and arrival tips.",
    },
    {
    ...
    {
      question: "Do you offer Invisalign for Cupertino patients?",
      answer:
        "Yes. Invisalign is a popular option for Cupertino patients who want a discreet orthodontic plan.",
    },
    {
  ...
  const faqSchema = buildFAQSchema(faqs, "/dentist-cupertino");
  ...
  const relatedServices: RelatedServiceLink[] = [
    ...
    {
      href: "/invisalign",
      anchorText: "Invisalign near Cupertino",
      description: "Clear aligners for teens and adults.",
    },
    {
      href: "/emergency-dental",
      anchorText: "Emergency dentist near Cupertino",
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Family dentistry for Cupertino patients
            </h2>
            <p className="text-slate-700 leading-relaxed">
              Cupertino families often want a practice that feels calm, consistent, and easy to work with. We focus on
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold font-heading text-[#1F2933]">
              Common visits for Cupertino families
            </h2>
            <p className="text-slate-700 leading-relaxed">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              is a popular option for Cupertino patients because it fits work and school schedules. For cosmetic goals,
          ...
          <div className="rounded-2xl border border-slate-100 bg-[#F5F9FC] p-6 md:p-8">
            <h2 className="text-2xl md:text-3xl font-bold font-heading text-[#1F2933] mb-4">
              Planning your visit from Cupertino
            </h2>
...
export default DentistCupertino;
